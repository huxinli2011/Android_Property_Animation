...
//        matrix.postTranslate(pos[0] - mArrawBmp.getWidth() / 2, pos[1] - mArrawBmp.getHeight() / 2);
         ...
         */
        Matrix matrix = new Matrix();
        mPathMeasure.getMatrix(stop, matrix, PathMeasure.POSITION_MATRIX_FLAG | PathMeasure.TANGENT_MATRIX_FLAG);  //PathMeasure.POSITION_MATRIX_FLAG获取位置信息，PathMeasure.TANGENT_MATRIX_FLAG获取切边信息
