...
//                repeatAnimator.removeAllListeners();
    ...
    private ValueAnimator doRepeatAnim(){
        ...
        animator.setRepeatMode(ValueAnimator.REVERSE);//循环模式，REVERSE倒序重新开始，RESTART正序重新开始
        animator.setRepeatCount(ValueAnimator.INFINITE);//设置循环次数，INFINITE代表无限次循环
        animator.setDuration(1000);
        animator.start();
        return animator;
    }
}
//animator.setStartDelay(long ss) 延时多久开始动画
