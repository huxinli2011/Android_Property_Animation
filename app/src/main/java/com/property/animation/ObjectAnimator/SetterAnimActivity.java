...
public class SetterAnimActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.object_anim_alpha_activity);
    ...
    public void onClick(View v) {
        ...
        findViewById(R.id.start_translationX).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                 ...
                 * translationX动画
                 */
                ObjectAnimator animator = ObjectAnimator.ofFloat(tv, "translationX", 0, 200, -200,0);//表示移动的距离
                animator.setDuration(2000);
                animator.start();
            }
        });
        ...
        findViewById(R.id.start_scaleX).setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                 ...
                 * scaleX缩放动画
                 */
                ObjectAnimator animator = ObjectAnimator.ofFloat(tv, "scaleX", 0, 3, 1); //表示缩放的倍数
                animator.setDuration(2000);
                animator.start();
            }
        });
